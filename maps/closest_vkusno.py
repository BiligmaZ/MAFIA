...
def closest_vkusno(city, address):
    # Нахождение ближайшего Вкусно - и точка!
    # :param city: Город пользователя
    # :param address: Адрес пользователя
    # :return: Название файла с картой, название Вкусно - и точка!, расстояние до Вкусно - и точка!, адрес, время работы
    orig_path = os.getcwd()
    toponym_pharmacy_tochno = 'Рядом с вами нету Вкусно - и точка! или попробуйте ввести адрес подругому'
    try:
